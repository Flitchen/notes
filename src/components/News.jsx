...
function News() {
    return (
        <div className='container mt-4'>
            ...
            < div class="alert alert-info mt-3 text-center">
                Deadline for submitting group assignment of Information System Management will be on <u>15<sup>th</sup> May 2023</u>. The assignment should be done with not more than 4 people
            </div>
